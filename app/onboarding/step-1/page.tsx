...
import { ArrowRight, BarChart3, CandlestickChart, UserRound } from "lucide-react";

export const metadata: Metadata = {
  title: "TradePilot - Onboarding Step 1"
};
      ...
      <main className="relative z-10 flex flex-1 items-center justify-center p-8">
          ...
          <div className="flex h-full flex-col gap-2">
            ...
            <div className="relative mt-2 flex-grow">
              <svg className="h-full w-full" preserveAspectRatio="none" viewBox="0 0 100 50">
                <path d="M0 40 Q 20 20, 40 30 T 80 10 L 100 20 L 100 50 L 0 50 Z" fill="rgba(77,142,255,0.1)" />
                <path
                  className="drop-shadow-[0_0_5px_rgba(173,198,255,0.5)]"
                  d="M0 40 Q 20 20, 40 30 T 80 10 L 100 20"
                  fill="none"
                  stroke="#adc6ff"
                  strokeWidth="1.5"
                />
        ...
        <div className="glass-panel absolute right-10 top-1/3 hidden h-56 w-48 rotate-3 rounded-xl border border-white/5 p-4 shadow-[0_0_30px_rgba(76,215,246,0.05)] lg:block">
          <div className="flex h-full flex-col gap-3">
            <div className="flex items-center justify-between">
              ...
              <div className="text-xs text-tertiary">+2.4%</div>
            </div>
            <div className="mt-2 flex flex-grow items-end gap-1">
              <div className="h-1/3 w-1/4 rounded-t-sm bg-primary/20" />
              <div className="h-2/3 w-1/4 rounded-t-sm bg-primary/40" />
              <div className="h-full w-1/4 rounded-t-sm bg-secondary/60 shadow-[0_0_10px_rgba(76,215,246,0.3)]" />
              <div className="h-1/2 w-1/4 rounded-t-sm bg-primary/30" />
            </div>
          </div>
        </div>
        ...
        <div className="z-20 flex w-full max-w-xl flex-col gap-stack-lg">
          <div className="flex flex-col gap-stack-sm text-center md:text-left">
            <h1 className="font-headline text-headline-xl text-on-surface">Initiate Protocol</h1>
            <p className="max-w-md font-body text-body-lg text-on-surface-variant">
              Enter your operational designation to begin configuring your terminal.
            </p>
          </div>

          <form action="/onboarding/step-2" className="mt-4 flex flex-col gap-stack-lg" method="get">
