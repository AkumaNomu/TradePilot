  ...
  return (
    <>
      <PageHeader
        ...
        title="AI playbooks built"
        accent="for your portfolio."
        description="Actionable plays tailored to market, segment, and client readiness."
      />

      <section className="route-grid">
        <article className="route-card">
          <span className="route-card-icon"><Compass size={18} /></span>
        ...
        <article className="route-card">
          <span className="route-card-icon"><BookOpen size={18} /></span>
